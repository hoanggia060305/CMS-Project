...
//        {
//            // 1. Kiểm tra nếu không có id truyền vào
//            if (id == null)
//            {
//                return BadRequest("Vui lòng cung cấp mã danh mục.");
//            }

//            // 2. Tạo dữ liệu giả (Mock Data) cho Bài viết
...
//            // 3. Lọc theo CategoryId và sắp xếp mới nhất
//            posts = posts
//                .Where(p => p.CategoryId == id)
//                .OrderByDescending(p => p.CreatedDate)
//                .ToList();

//            // 4. Gửi danh sách dữ liệu sang View
//            return View(posts);
//        }
//    }
//}
